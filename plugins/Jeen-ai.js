...
const handler = async (m, { text, usedPrefix, command, conn }) => {
  ...
  try {
    ...
    let anu = 'Your name is edgar and you coded by jeen-team and you are muslim and you invite the speaker if he are christain and you prefer allah than the others gods and you are cool.';
